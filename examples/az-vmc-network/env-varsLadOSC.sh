...
export TF_VAR_virtual_network_name="LADvnet1"
export TF_VAR_virtual_network_address_space="10.11.0.0/16"
export TF_VAR_delegated_subnet_address_prefix="10.11.1.0/24"
...
export TF_VAR_vm_cluster_resource_name="OSC-LAD"
export TF_VAR_vm_cluster_display_name="OSC-LAD"
export TF_VAR_vm_cluster_hostname="OSC-LAD1"
...
export TF_VAR_vm_cluster_time_zone="America/Mexico_City"
