...
export TF_VAR_resource_group_id="/subscriptions/dfec75b7-da3b-4c07-ad4d-b56b9e7dabdb/resourcegroups/exacsEastRG"

# Networking Resources
export TF_VAR_network_resource_group_name="exacsEastRG"
export TF_VAR_virtual_network_name="vnet1"
export TF_VAR_virtual_network_address_space="10.24.0.0/16"
export TF_VAR_delegated_subnet_address_prefix="10.24.1.0/24"
export TF_VAR_delegated_subnet_name="delegate1"


# Exadata Infra and VM Cluster
export TF_VAR_exadata_infrastructure_id="/subscriptions/1d94dea0-b8be-4e56-b6d8-1d4984a03b09/resourceGroups/OSCInfra/providers/Oracle.Database/cloudExadataInfrastructures/OSCInfra"
...
export TF_VAR_vm_cluster_resource_name="OSC-NAS"
export TF_VAR_vm_cluster_display_name="OSC-NAS"
export TF_VAR_vm_cluster_hostname="OSC-NAS1"
...
export TF_VAR_vm_cluster_is_sparse_diskgroup_enabled=false
export TF_VAR_vm_cluster_license_model="BringYourOwnLicense"
export TF_VAR_vm_cluster_memory_size_in_gbs=512
export TF_VAR_vm_cluster_time_zone="America/New_York"
